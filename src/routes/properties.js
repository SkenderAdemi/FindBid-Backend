...
router.post('/', async (req, res, next) => {
  try {
    ...
    const serviceType = req.body.serviceType != null ? String(req.body.serviceType).trim() : 'property';
    const allowed = ['barber', 'beauty', 'handyman', 'cleaning', 'repair', 'property'];
    const serviceTypeFinal = allowed.includes(serviceType) ? serviceType : 'property';
